...
- **対象ESファイル**: 企業名が指定されていれば以下を順に探す
  1. `/Users/ishidatomonori/Desktop/knowledge/ES/submitted/<企業名>.md`
  2. `/Users/ishidatomonori/Desktop/knowledge/移行後ES/<企業名>.md`
  3. `/Users/ishidatomonori/Desktop/knowledge/ES/drafts/<企業名>.md`

ファイルが見つからない場合は一覧を提示して終了:
```bash
ls /Users/ishidatomonori/Desktop/knowledge/ES/submitted/
...
```bash
ls /Users/ishidatomonori/Desktop/knowledge/ES/components/foundations/ 2>/dev/null
```
...
`/Users/ishidatomonori/Desktop/knowledge/ES/components/update_log.md` に追記する。
