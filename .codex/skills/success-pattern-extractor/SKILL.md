...
description: >
  ...
  ES/components/best_answers.md に「実績あり」タグ付きで反映、
...
Step 2・3 の分析結果を踏まえ、`ES/components/best_answers.md` の該当回答に実績タグを追加する。
...
1. `ES/components/best_answers.md` — 実績タグの追記
2. `docs/interview_patterns.md` — 成功パターンの追記
3. `docs/success_record.md` — 通過実績と集計サマリーの更新

```
保存完了:
- ES/components/best_answers.md（実績タグ N件追記）
